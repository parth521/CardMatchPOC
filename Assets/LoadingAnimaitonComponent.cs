...
public class LoadingAnimaitonComponent : UIAnimations
{
    ...
    {
        StartCoroutine(LerpAnchors(fromShow,toShow, duration));
    }

    public override void Hide(Action callback = null)
    {
        StartCoroutine(LerpAnchors(fromHide,toHide, duration,callback));
    }
    private IEnumerator LerpAnchors(float startValue, float endValue, float time,Action onComplete = null)
    {
